...
```{r}
shiny::includeHTML("https://kyiyeunggoh.github.io/Assignments%20/Combined%20project/hu.html")
```
...
```{r}
shiny::includeHTML("https://kyiyeunggoh.github.io/Assignments%20/Combined%20project/xi.html")
```

### International travel map: Want to explore more of the travels of the various presidents? Try playing with the map at the [link here](https://auroraluyunshao.github.io/Final_02_IntTravel/). Simply pull over the days that you wish to investigate to look at the paths taken.

![Snippet of interactive map](mapimage.png)
...
Some interesting points that may shed insights into their policy choices.


**A full list of all data and code is attached below via GitHub links, the pages make the data ready downloadable for further analysis via the DT package in R. **
...
[Domestic travel data](kyiyeunggoh.github.io/Assignments /Final Project/China_President_Domestic.html)

[In and Out data & Radius calculations](kyiyeunggoh.github.io/Assignments /Final Project/China_InOut.html)
