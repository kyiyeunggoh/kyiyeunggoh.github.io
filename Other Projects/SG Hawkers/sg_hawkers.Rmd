...
meta() %>%
  ...
  meta_social(
    ...
    image = "photos/hawker_ets_1970.JPG",
...
With alternative sources of employment and strong economic growth by the early 1970s, the government decided to go full steam ahead to relocate hawkers and clamp down on illegal hawking. In 1974, the Hawker Department’s Special Squad was established and tasked by the Permanent Secretary (Environment) to clear all illegal hawkers within 18 months. This was achieved in 6 months. While the government continued to clamp down on illegal hawking, it also worked to minimise the frictions associated with mass relocation. They recognised the need to build hawker centers, fast. 
